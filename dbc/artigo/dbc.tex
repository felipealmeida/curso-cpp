...
\lstset{basicstyle=\small,language=C++,stringstyle=\ttfamily,showstringspaces=false,keywordstyle=\color{blue},float=h!,frame=lines,mathescape=true}
...
\lstinputlisting[label=lst:example1,caption={Exemplo 1},firstline=6,lastline=9]{../cpp/divide.cpp}
